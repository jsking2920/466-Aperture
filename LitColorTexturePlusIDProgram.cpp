#include "LitColorTexturePlusIDProgram.hpp"

#include "gl_compile_program.hpp"
#include "gl_errors.hpp"

Scene::Drawable::Pipeline lit_color_texture_plus_id_program_pipeline;

Load< LitColorTexturePlusIDProgram > lit_color_texture_plus_id_program(LoadTagEarly, []() -> LitColorTexturePlusIDProgram const* {
	LitColorTexturePlusIDProgram* ret = new LitColorTexturePlusIDProgram();

	//----- build the pipeline template -----
	lit_color_texture_plus_id_program_pipeline.program = ret->program;

	lit_color_texture_plus_id_program_pipeline.OBJECT_TO_CLIP_mat4 = ret->OBJECT_TO_CLIP_mat4;
	lit_color_texture_plus_id_program_pipeline.OBJECT_TO_LIGHT_mat4x3 = ret->OBJECT_TO_LIGHT_mat4x3;
	lit_color_texture_plus_id_program_pipeline.NORMAL_TO_LIGHT_mat3 = ret->NORMAL_TO_LIGHT_mat3;

	/* This will be used later if/when we build a light loop into the Scene:
	lit_color_texture_plus_id_program_pipeline.LIGHT_TYPE_int = ret->LIGHT_TYPE_int;
	lit_color_texture_plus_id_program_pipeline.LIGHT_LOCATION_vec3 = ret->LIGHT_LOCATION_vec3;
	lit_color_texture_plus_id_program_pipeline.LIGHT_DIRECTION_vec3 = ret->LIGHT_DIRECTION_vec3;
	lit_color_texture_plus_id_program_pipeline.LIGHT_ENERGY_vec3 = ret->LIGHT_ENERGY_vec3;
...
LitColorTexturePlusIDProgram::LitColorTexturePlusIDProgram() {
